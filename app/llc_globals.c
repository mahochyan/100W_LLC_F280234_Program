...
volatile Uint32 g_real_active_isr_cycles_max   = 0UL;
volatile Uint32 g_real_shutdown_isr_cycles_max = 0UL;
...
volatile Uint32 g_timing_compute_normal_max = 0UL;
volatile Uint32 g_timing_compute_fmax_max   = 0UL;
volatile Uint32 g_timing_compute_abort_max  = 0UL;
...
volatile Uint16 g_burst_entry_phase;
volatile Uint32 g_burst_entry_unclamped_hz;
volatile Uint16 g_burst_entry_unclamped_period;
volatile int32  g_burst_entry_pi_integral_q12;
volatile Uint16 g_burst_entry_applied_period;
volatile Uint32 g_control_unclamped_frequency_hz;
volatile Uint16 g_control_unclamped_period;
volatile Uint32 g_control_fmax_saturate_count;
...
volatile Uint16 g_burst_restart_snapshot_period;
volatile Uint16 g_burst_restart_snapshot_cmpa;
