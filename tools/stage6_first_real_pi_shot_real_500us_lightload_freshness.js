// STAGE6_500US_LIGHTLOAD_FRESHNESS_DIAGNOSTIC_V1 — single 500us LIGHT-LOAD REAL PI SHOT.
...
//   DSH_SINGLE_500US_SHOT_AUTHORIZED=1.
...
// Uses the new freshness/stale-write firmware (root-cause commit 2dae576).
// Entry-interval gate: <=1230 (TINT0 period 1200 + Timer2 read-back window,
// recorded artifact; overrun==0 is the real-time violation signal).
...
var single=(System.getenv("DSH_SINGLE_500US_SHOT_AUTHORIZED")||"").equals("1");
print("Single 500us authorized: "+single);
if(!single){ print("ABORT: DSH_SINGLE_500US_SHOT_AUTHORIZED != 1."); throw "no-single-500us"; }
...
if (fails===0) { print("STAGE6_500US_LIGHTLOAD_FRESHNESS_DIAGNOSTIC_PASS"); }
else { print("STAGE6_500US_LIGHTLOAD_FRESHNESS_DIAGNOSTIC_FAIL"); }
print("500US_LIGHTLOAD_FRESHNESS_DONE");
