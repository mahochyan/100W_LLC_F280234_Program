// STAGE6_BURST_RESTART_REAL_PREFLIGHT - no arm, no enable, no power
...
if(!perm || !op){ print("ABORT: preflight gates not all 1."); throw "noauth"; }
...
var fault=rv32("g_fault_flags"); var pwm=rw("g_pwm_enabled"); var ost=reg("EPwm1Regs.TZFLG.bit.OST");
var cfa=reg("EPwm1Regs.AQCSFRC.bit.CSFA"); var cfb=reg("EPwm1Regs.AQCSFRC.bit.CSFB");
print("PREFLIGHT fault="+fault+" pwm="+pwm+" ost="+ost+" cfa="+cfa+" cfb="+cfb);
print("REAL_PREFLIGHT_PASS="+((fault===0)&&(pwm===0)&&(ost==="1")&&(cfa==="1")&&(cfb==="1")));
