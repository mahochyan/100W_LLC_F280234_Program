...
set BUILD=%PROJ%\Stage6_FLASH_SHOT_REAL

if exist "%BUILD%" rmdir /s /q "%BUILD%"
mkdir "%BUILD%"

echo === CGT 25.11.1.LTS clean Stage6_FLASH_SHOT_REAL compile (COFF, REAL bounded shot) ===
...
echo === BUILD OK (Stage6_FLASH_SHOT_REAL, CGT 25.11.1.LTS, COFF, SHOT REAL) ===
endlocal
