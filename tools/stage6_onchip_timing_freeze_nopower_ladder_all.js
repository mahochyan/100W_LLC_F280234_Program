...
// STAGE6_ONCHIP_TIMING_FREEZE_AND_CR20_LADDER_V1 - one-shot no-power ladder.
// Runs REAL_2MS, REAL_10MS, REAL_100MS in order. Each must PASS before the
// next is attempted. No retry on a gate failure.
//
// Expected SHA values are read from evidence/stage6_first_real_pi_shot_real/
// REAL_LADDER_SHA256SUMS.txt (REAL_2MS_OUT_SHA256=..., etc.). If the file is
...
var CONFIGS = [
  ...
  { label:"10MS", out:BASE+"\\LLC_100W_F28034_BRINGUP_DSH_REAL_10MS.out", waitMs:25,  shaKey:"REAL_10MS_OUT_SHA256" },
  { label:"100MS",out:BASE+"\\LLC_100W_F28034_BRINGUP_DSH_REAL_100MS.out",waitMs:130, shaKey:"REAL_100MS_OUT_SHA256" }
];
