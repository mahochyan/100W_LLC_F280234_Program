// STAGE6_40US_SPLIT_PIPELINE — G: single 500us NO-EXTERNAL-LOAD REAL PI SHOT.
...
chk("PIPELINE_FAST_TICKS_26", sfk===26);
chk("PIPELINE_PI_COMPUTE_COUNT_14", spc===14);
chk("PIPELINE_PWM_APPLY_COUNT_13", sac===13);
chk("SHOT_TICK_26", tk===26);
chk("POWER_WRITES_13", pw===13);
...
if (fails===0) { print("STAGE_G_500US_NOLOAD_REAL_SHOT_PASS"); }
else { print("STAGE_G_500US_NOLOAD_REAL_SHOT_FAIL"); }
