// STAGE6_SINGLE_500US_EXACT_CR50OHM_DIAGNOSTIC_V1
// Single 500us real PI diagnostic with exact electronic-load CR 50.0 ohm.
// Operator-authorized single run:
//   CNT3/CNT4 = CONNECTED, Vin = 24V, current limit = 0.5A, load = CR 50.0 ohm,
//   DSH_LOAD_MODE_CR50_CONFIRMED=1, DSH_CNT34_CONNECTED_CONFIRMED=1,
//   DSH_SINGLE_CR50_500US_SHOT_AUTHORIZED=1.
...
var cr50=(System.getenv("DSH_LOAD_MODE_CR50_CONFIRMED")||"").equals("1");
print("CR50 load confirmed: "+cr50);
if(!cr50){ print("ABORT: DSH_LOAD_MODE_CR50_CONFIRMED != 1."); throw "no-cr50"; }

var single=(System.getenv("DSH_SINGLE_CR50_500US_SHOT_AUTHORIZED")||"").equals("1");
print("Single CR50 500us authorized: "+single);
if(!single){ print("ABORT: DSH_SINGLE_CR50_500US_SHOT_AUTHORIZED != 1."); throw "no-single-cr50"; }
...
if (fails===0) { print("EXACT_CR50OHM_500US_POWER_BEHAVIOR_PASS"); }
else { print("EXACT_CR50OHM_500US_POWER_BEHAVIOR_FAIL"); }
print("CR50_500US_REAL_DONE");
