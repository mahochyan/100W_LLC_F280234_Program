// STAGE6_40US_SPLIT_PIPELINE — G: single 300us NO-EXTERNAL-LOAD REAL PI SHOT.
...
chk("TIMER2_DELTA_17500_20500", t2d>=17500 && t2d<=20500);
...
chk("PIPELINE_FAST_TICKS_15", sfk>=15 && sfk<=16);
chk("PIPELINE_PI_COMPUTE_COUNT_8", spc>=8 && spc<=9);
chk("PIPELINE_PWM_APPLY_COUNT_8", sac>=8 && sac<=9);
chk("SHOT_TICK_15", tk>=15 && tk<=16);
...
if (fails===0) { print("STAGE_G_300US_NOLOAD_REAL_SHOT_PASS"); }
else { print("STAGE_G_300US_NOLOAD_REAL_SHOT_FAIL"); }
