// STAGE6_40US_SPLIT_PIPELINE — G: single 1ms NO-EXTERNAL-LOAD REAL PI SHOT.
...
if (fails===0) { print("STAGE_G_1MS_NOLOAD_REAL_SHOT_PASS"); }
else { print("STAGE_G_1MS_NOLOAD_REAL_SHOT_FAIL"); }
