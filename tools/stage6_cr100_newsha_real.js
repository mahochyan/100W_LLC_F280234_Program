...
var OUT="D:\\100W_LLC_F280234_Program\\branch_first_real_pi_shot_v1_1\\evidence\\stage6_first_real_pi_shot_real\\LLC_100W_F28034_BRINGUP_DSH_REAL_SHOT_HANDOFF_FIX_BE752B16.out";
var EXPECTED="BE752B16020DE9764361829943CD0178ABDC0BAA108E03D8FD3504B63115DF94";
...
var cr100=(System.getenv("DSH_CR100OHM_CONFIRMED")||"").equals("1");
var single=(System.getenv("DSH_SINGLE_NEW_SHA_500US_AUTHORIZED")||"").equals("1");
print("Permanent CNT34: "+perm+" operator present: "+op+" CR100: "+cr100+" single new-SHA: "+single);
if(!perm || !op || !cr100 || !single){ print("ABORT: new-SHA CR100 gates not all 1."); throw "no-cr100-auth"; }
