...
```text
STATE_VERSION=66
UPDATED_AT=2026-09-05T22:54:32+08:00
MASTER_STATUS=IN_PROGRESS__XDS_DISCONNECT_FORENSICS_COMPLETE__NO_DRIVER_OR_EEPROM_WRITE__PREEXISTING_HUB_LINK_INSTABILITY__DIRECT_BYPASS_REQUIRED
CURRENT_WORK_ORDER=W4
CURRENT_GATE=W4_XDS_STANDALONE_DIRECT_MOTHERBOARD_USB_ENUMERATION_WITH_VIN24_OFF_AND_TARGET_JTAG_ISOLATED
CURRENT_CHECKPOINT=XDS_AND_PARENT_HUB_REMOVED13H22M42_WHILE_NO_COMMAND_RUNNING__SAME_ROOT_HS09_NOW_CODE43_DESCRIPTOR_FAILURE__REAL_STARTED_AFTER_REMOVAL_AND_DID_NOT_CONNECT_LOAD_OR_FIRE
LAST_VERIFIED_WORK_ORDER=W3__W4_CR10_INSERTION_COMPLETE
NEXT_ACTION=Keep Vin24 off; detach XDS from target JTAG; bypass the failing Genesys hub and connect XDS by a known-good USB cable directly to a different motherboard port; perform PnP-only identity check before any DSS action.
BOARD_LAST_STATE=USER_CONFIRMED_REAL_24V_OFF__ELOAD_CR15_SETTING_CARRIED_FORWARD__ROOT_HUB_OK__HS09_USB_DEVICE_DESCRIPTOR_FAILURE_CODE43__XDS_AND_GENESYS_HUB_PHANTOM__REAL_NOT_LOADED_OR_FIRED
PHYSICAL_ACTION_REQUIRED=KEEP_VIN24_OFF__DETACH_TARGET_JTAG__DIRECT_CONNECT_XDS_USB_TO_DIFFERENT_MOTHERBOARD_PORT_WITH_KNOWN_GOOD_CABLE__NO_DISCHARGE_REASK
...
W4_V14_ON_TARGET_NE=NOT_RUN__REAL24V_OFF_REQUIRED_BEFORE_LOAD
W4_V14_REGRESSIONS=NOT_RUN_FOR_FINAL_SHA
