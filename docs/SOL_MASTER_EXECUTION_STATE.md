...
```text
STATE_VERSION=2
UPDATED_AT=2026-08-25T23:40:26+08:00
MASTER_STATUS=IN_PROGRESS_OFFLINE_ROOT_CAUSE
CURRENT_WORK_ORDER=W2
CURRENT_GATE=W2_POWER_REDUCTION_AUTHORITY_CANDIDATE_QUALIFICATION
CURRENT_CHECKPOINT=W2_CR15_ATTEMPT1_VOUT_ABORT__ROOT_CAUSE_CLASSIFIED__CANDIDATE2_IN_PROGRESS
LAST_VERIFIED_WORK_ORDER=W1
NEXT_ACTION=Build and qualify the +1000Hz/fresh-compute power-reduction candidate; only after all no-power gates pass execute its unique new-SHA CR15 ladder.
...
W2_REAL_RETRY_ALLOWED=0_UNTIL_CANDIDATE2_ALL_NOPOWER_GATES_PASS
