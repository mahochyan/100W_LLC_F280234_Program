...
```text
STATE_VERSION=60
UPDATED_AT=2026-09-05T11:57:33+08:00
MASTER_STATUS=IN_PROGRESS__REAL_POWER_OFF__W4_V13_READY_FOR_CR12_TO_CR15_REAL
CURRENT_WORK_ORDER=W4
CURRENT_GATE=W4_V13_CR12_TO_CR15_REAL_AFTER_PROBE_RECOVERY_AND_ON_TARGET_NE
CURRENT_CHECKPOINT=W4_V13_PROFILE_BOUND__ON_TARGET_NE_AND_ALL_REGRESSIONS_PASS__205S_QUIET_LINK_PASS__XDS_POST_TEST20_OF20__READY_FOR_LIGHTER_REAL
LAST_VERIFIED_WORK_ORDER=W3__W4_CR10_INSERTION_COMPLETE
NEXT_ACTION=Operator powers real 24V on while keeping ELOAD CR12 and input limit 0.5A; locally run exact-SHA V13 LIGHTER CR12-to-CR15 capture and wait for the nonce-bound load-change marker.
BOARD_LAST_STATE=REAL_24V_OFF__ELOAD_CR12__INPUT_LIMIT0P5A_CARRIED_FORWARD__LAST_NE_PWM0_OST1_TZINT0_FAULT0__XDS_PRESENT_OK_AND20_OF20_POST205S__NO_STALE_DSS_PROCESS
PHYSICAL_ACTION_REQUIRED=TURN_ON_REAL_24V__KEEP_ELOAD_CR12__INPUT_LIMIT0P5A__NO_DISCHARGE_REASK
