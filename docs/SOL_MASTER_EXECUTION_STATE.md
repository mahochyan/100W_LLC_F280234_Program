...
```text
STATE_VERSION=58
UPDATED_AT=2026-09-05T11:38:28+08:00
MASTER_STATUS=IN_PROGRESS__REAL_POWER_ON__UNCONFIRMED_TARGET__POWER_OFF_REQUIRED
CURRENT_WORK_ORDER=W4
CURRENT_GATE=W4_V13_CR15_CR12_PROFILE_REBASE_AND_PROBE_RECOVERY
CURRENT_CHECKPOINT=W4_V12_INVALID_UNVERIFIED__ACTUAL_CR15_TO_CR12_STEP_AT_HOST_PLUS1038S_OUTSIDE_WINDOW__FTDI_MINUS150__TWO_BOUNDED_STATUS_FALSE__HOST_NO_HALT_READ_OR_CLEANUP
LAST_VERIFIED_WORK_ORDER=W3__W4_CR10_INSERTION_COMPLETE
NEXT_ACTION=Operator turns off real 24V while keeping ELOAD at CR12; locally bind V13 to the requested CR15<->CR12 profile and new SHA, then recover/verify XDS before any reconnect or reload.
BOARD_LAST_STATE=REAL_24V_ON__ELOAD_CR12__INPUT_LIMIT0P5A_CARRIED_FORWARD__TARGET_STATE_UNCONFIRMED__DSS_PROCESS_EXITED_WITHOUT_HALT_OR_CLEANUP__XDS_PNP_UNKNOWN
PHYSICAL_ACTION_REQUIRED=TURN_OFF_REAL_24V_NOW__KEEP_ELOAD_CR12__NO_DISCHARGE_REASK
