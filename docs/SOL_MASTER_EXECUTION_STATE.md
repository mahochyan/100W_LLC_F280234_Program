...
```text
STATE_VERSION=79
UPDATED_AT=2026-09-06T01:21:00+08:00
MASTER_STATUS=IN_PROGRESS__W4_V15_PROTECTED_BURST_RETURN_OFFLINE_QUALIFIED__WAITING_SINGLE_PHYSICAL_CR12_AND0P5A_SETUP__ORIGINAL_PI_PFM_GATE_DEFERRED
...
NEXT_ACTION=Operator sets the electronic load from current CR8 to CR12 and the 24 V source current limit to 0.5 A once; after confirmation finish XDS identity, fire frozen V15 SHA A2148D52 once, then operator changes only to CR15 at the persistent target-yellow/local cue.
BOARD_LAST_STATE=V2_AUTONOMOUS_TERMINAL_PWM0_OST1_TZINT0_FAULT0__COUNT400_CHECKSUM_COOKIE_MATCH__VIN24_INPUT1P2A__USER_CONFIRMED_ACTUAL_ELOAD_ENDPOINT_CR8
PHYSICAL_ACTION_REQUIRED=SET_ELOAD_CR12__SET_24V_SOURCE_CURRENT_LIMIT0P5A__KEEP_VIN24__CONFIRM_ONCE
