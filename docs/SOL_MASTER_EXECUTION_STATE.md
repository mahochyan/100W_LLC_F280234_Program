...
```text
STATE_VERSION=77
UPDATED_AT=2026-09-06T00:47:30+08:00
MASTER_STATUS=IN_PROGRESS__W4_SUPPLEMENTAL_SWEEP_V2_SAFE_TERMINAL_BUT_COORDINATION_INVALID__OPERATOR_ACTUAL_ENDPOINT_CR8__V3_LONG_VISIBLE_CUE_FIX_IN_PROGRESS
CURRENT_WORK_ORDER=W4
CURRENT_GATE=W4_SUPPLEMENTAL_CR20_TO_CR5_V3_LONG_VISIBLE_CUE_RECORDER_OFFLINE_CHANGE
CURRENT_CHECKPOINT=V2_RUN0x25090601_SHA_D1028493_FIRED_ONCE__SAFE_COMPLETE400BINS__VOUT5PCT_PASS__USER_CONFIRMED_ACTUAL_ONLY_CR20_TOCR8__SCHEDULED_LABELS_INVALID__DO_NOT_RETRY
LAST_VERIFIED_WORK_ORDER=W3__W4_CR10_INSERTION_COMPLETE
NEXT_ACTION=Use V2 measured operator latency and last-nine-bin cadence dilation to build a distinct V3 with longer levels and directly visible terminal cues; requalify offline, then ask once to return CR8 to CR20 before the new fire.
...
PHYSICAL_ACTION_REQUIRED=NONE_DURING_V3_OFFLINE_FIX__WHEN_READY_RETURN_CR8_TOCR20_ONCE
