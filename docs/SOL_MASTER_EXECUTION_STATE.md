...
```text
STATE_VERSION=4
UPDATED_AT=2026-08-26T00:30:00+08:00
MASTER_STATUS=ENGINEERING_BLOCKED
CURRENT_WORK_ORDER=W2
CURRENT_GATE=W2_HANDOFF_ENERGY_STATE_CONTINUITY_CANDIDATE
CURRENT_CHECKPOINT=W2_THREE_REAL_ATTEMPTS_EXHAUSTED__200K_DB140_AUDIT_ACCEPTED__ENGINEERING_BLOCKED
LAST_VERIFIED_WORK_ORDER=W1
NEXT_ACTION=Await operator-provided true trip waveform / IPRI / ZVS instrumentation or a new authorized root-cause direction. No same-SHA retry.
BOARD_LAST_STATE=AFTER_REAL_RUN_PWM0_OST1_TZINT0__FAULT_0x10000
PHYSICAL_ACTION_REQUIRED=TRUE_TRIP_WAVEFORM_OR_NEW_AUTHORIZED_DIRECTION_REQUIRED; CR15 load and bench safety remain maintained.
...
SOL_MASTER_EXECUTION_ENGINEERING_BLOCKED=TRUE__FAILED_WORK_ORDER=W2__FAILED_GATE=MAX_VOUT_RAW_LT_1367__ATTEMPTED_ROOT_CAUSES=W2_ATTEMPT1__CANDIDATE2_FAST_SLEW__CANDIDATE3_HANDOFF_BRAKE
