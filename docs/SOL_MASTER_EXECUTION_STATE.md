...
```text
STATE_VERSION=51
UPDATED_AT=2026-09-05T02:31:10+08:00
MASTER_STATUS=IN_PROGRESS
CURRENT_WORK_ORDER=W4
CURRENT_GATE=W4_V10_CR12P5_TO_CR15_LIGHTER_REAL_STEP_READY
CURRENT_CHECKPOINT=W4_V10_NEW_SHA_OFFLINE_QUALIFIED__CR12P5_PRESENT__READY_LIGHTER_REAL
LAST_VERIFIED_WORK_ORDER=W3__W4_CR10_INSERTION_COMPLETE
NEXT_ACTION=Run the exact V10 SHA in the CR12.5-to-CR15 lighter direction; the pre-fire 200 ms target-clock gate must pass before power and the operator changes only the load at the printed marker.
BOARD_LAST_STATE=AFTER_W4_V10_FINAL_NOENERGY_REGRESSIONS__PWM0_OST1_TZINT0_FAULT0
PHYSICAL_ACTION_REQUIRED=AT_PRINTED_MARKER_SET_ELOAD_CR15__KEEP_VIN24__KEEP_INPUT_LIMIT0P5A__NO_DISCHARGE_REASK
...
| W4 | IN PROGRESS | V10 early-detect/new SHA fully qualified offline; CR12.5 present; lighter real step next |
