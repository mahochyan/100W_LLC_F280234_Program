...
```text
STATE_VERSION=74
UPDATED_AT=2026-09-06T00:15:16+08:00
MASTER_STATUS=IN_PROGRESS__W4_SUPPLEMENTAL_SWEEP_V1_SAFE_TERMINAL_BUT_INVALID_NO_EFFECTIVE_LOAD_CHANGE__NEW_SHA_CUE_FIX_IN_PROGRESS
CURRENT_WORK_ORDER=W4
CURRENT_GATE=W4_SUPPLEMENTAL_CR20_TO_CR5_V2_VISIBLE_CUE_RECORDER_OFFLINE_CHANGE
CURRENT_CHECKPOINT=V1_RUN0x2509059C_SHA_AEF6083F_FIRED_ONCE__TARGET_SAFE_COMPLETE480BINS__VOUT_STABLE10V__DEMAND_FLAT21775_TO21878_MONOTONIC0OF15__INVALID_NO_EFFECTIVE_LOAD_CHANGE__DO_NOT_RETRY
LAST_VERIFIED_WORK_ORDER=W3__W4_CR10_INSERTION_COMPLETE
NEXT_ACTION=Build V2 under a distinct directory/SHA/run ID with 5s levels, at least 1.5s target LED cue, 2s transition and host-only timed text/beep cues; requalify then ask once for current CR20 before fire.
...
PHYSICAL_ACTION_REQUIRED=NONE_DURING_V2_OFFLINE_BUILD__WHEN_READY_SET_OR_CONFIRM_CR20_ONCE
