...
```text
STATE_VERSION=88
UPDATED_AT=2026-09-06__W5_CR15_BURST_POWER_VS_TZ_BOUNDARY_FROZEN
MASTER_STATUS=W5_BLOCKED_AT_W9_INSTRUMENTATION_BOUNDARY__NO_MORE_SOFTWARE_ONLY_REAL_FIRES
...
PHYSICAL_ACTION_REQUIRED=W9_SCOPE_PROBE_SETUP_REQUIRED_BEFORE_CONTINUING_REAL_POWER
