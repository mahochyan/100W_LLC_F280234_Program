...
```text
STATE_VERSION=50
UPDATED_AT=2026-09-05T02:24:25+08:00
MASTER_STATUS=IN_PROGRESS
CURRENT_WORK_ORDER=W4
CURRENT_GATE=W4_V10_EARLY_DETECT_NEW_SHA_OFFLINE_QUALIFICATION
CURRENT_CHECKPOINT=W4_HEAVIER_V9_INVALID_HOST_TARGET_TIME__SAFE_CLEANUP__CR12P5_PRESENT__NEW_SHA_REQUIRED
LAST_VERIFIED_WORK_ORDER=W3__W4_CR10_INSERTION_COMPLETE
NEXT_ACTION=Implement W4 V10 detection immediately after the completed 0.7 s baseline plus a pre-fire target-clock cadence hard gate; build a new SHA and complete all no-energy regressions before the CR12.5-to-CR15 real return run.
BOARD_LAST_STATE=AFTER_INVALID_W4_V9_HOST_HALT_AND_FORCE_SAFE__PWM0_OST1_TZINT0__FAULT0
PHYSICAL_ACTION_REQUIRED=NONE_DURING_OFFLINE_FIX__KEEP_VIN24__KEEP_ELOAD_CR12P5__KEEP_INPUT_LIMIT0P5A__NO_DISCHARGE_REASK
...
| W4 | IN PROGRESS | V9 heavier run invalidated by FTDI/target-time shortfall; safe cleanup; V10 early-detect/new-SHA qualification underway |
