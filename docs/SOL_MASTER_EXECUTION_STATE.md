...
```text
STATE_VERSION=64
UPDATED_AT=2026-09-05T13:24:20+08:00
MASTER_STATUS=IN_PROGRESS__V14_POWERED_NE_PASS__REAL_HEAVIER_PREFIRE_XDS151_NO_FIRE__USB_RECONNECT_REQUIRED
CURRENT_WORK_ORDER=W4
CURRENT_GATE=W4_V14_XDS_PHYSICAL_RECONNECT_AND_CORRECTED20_OF20_STABILITY_GATE
CURRENT_CHECKPOINT=W4_V14_REAL_HEAVIER_SHA_PASS_THEN_CONNECT_FAILED_FTDI_MINUS151__PROGRAM_NOT_LOADED__POWER_REQUEST_NOT_FIRED__SAME_SHA_RETRY_ALLOWED
LAST_VERIFIED_WORK_ORDER=W3__W4_CR10_INSERTION_COMPLETE
NEXT_ACTION=Operator physically reconnects XDS USB, preferably directly to a motherboard port, while Vin24 and CR15 stay unchanged; pass corrected composite/debug/aux/parent plus explicit-enumeration 20-of-20 gate; retry same REAL SHA because no fire occurred.
BOARD_LAST_STATE=REAL_24V_ON__ELOAD_CR15__INPUT_LIMIT0P5A_CARRIED_FORWARD__LAST_CONFIRMED_V14_NE_PWM0_OST1_TZINT0_FAULT0__XDS_AND_PARENT_HUB_REMOVED__REAL_NOT_LOADED_OR_FIRED
PHYSICAL_ACTION_REQUIRED=REPLUG_XDS_USB_ONLY__PREFER_DIRECT_MOTHERBOARD_PORT__KEEP_VIN24_CR15__NO_DISCHARGE_REASK
...
NEXT=REPLUG_XDS_USB_PREFER_DIRECT_MOTHERBOARD__KEEP_VIN24_CR15__RUN_CORRECTED20_OF20__RETRY_REAL
```
