...
```text
STATE_VERSION=36
UPDATED_AT=2026-09-05T01:19:46+08:00
MASTER_STATUS=IN_PROGRESS
CURRENT_WORK_ORDER=W4
CURRENT_GATE=W4_CR10_V9_REAL_500MS
CURRENT_CHECKPOINT=W4_CR10_V9_FULL_PHASE_A_PACKET_QUALIFIED__NEW_SHA_READY_FOR_500MS
LAST_VERIFIED_WORK_ORDER=W3
NEXT_ACTION=Run V9 exact REAL SHA 04F53526 at CR10 for 500ms; on PASS advance 2s, 10s, 60s.
BOARD_LAST_STATE=AFTER_W4_CR10_V9_NE_AND_SAFE_W2_REGRESSIONS__PWM0_OST1_TZINT0
...
NEXT=V9_CR10_REAL_500MS__then_2S_10S_60S_only_after_each_PASS
```
