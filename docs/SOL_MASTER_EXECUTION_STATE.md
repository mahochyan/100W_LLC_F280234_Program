...
CURRENT_CHECKPOINT=W2_CANDIDATE4_REAL_2MS_FAILED_TWICE__CR15_AND_500MA_CC__COMP_TZ1__PRE_BRAKE_HIGH_ABORT__NO_RETRY__NEXT_LOAD_NONE
...
| W2 | BLOCKED | Candidate4 REAL 2MS failed twice (CR15 15ohm and 500mA CC): COMP_TZ1 + pre-brake high abort; no retry; next load NONE |
