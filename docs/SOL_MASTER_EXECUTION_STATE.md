...
```text
STATE_VERSION=49
UPDATED_AT=2026-09-05T02:16:17+08:00
MASTER_STATUS=IN_PROGRESS
CURRENT_WORK_ORDER=W4
CURRENT_GATE=W4_CR15_TO_CR12P5_REAL_STEP_READY
CURRENT_CHECKPOINT=W4_ABA_TRACE_REAL_AND_NE_OFFLINE_QUALIFIED__W5_OFFLINE_PREFLIGHT_PASS__AWAIT_CR15_LIMIT0P5A
LAST_VERIFIED_WORK_ORDER=W3__W4_CR10_INSERTION_COMPLETE
NEXT_ACTION=Operator sets input current limit to 0.5 A and electronic load to CR15; then run one firmware-owned 60 s CR15-to-CR12.5 capture and change load only at the printed marker.
BOARD_LAST_STATE=AFTER_W4_FINAL_NOENERGY_QUALIFICATION__PWM0_OST1_TZINT0_FAULT0
PHYSICAL_ACTION_REQUIRED=SET_INPUT_CURRENT_LIMIT_0P5A_AND_ELOAD_CR15__KEEP_VIN24__REPLY_W4_CR15_READY=1__NO_DISCHARGE_REASK
...
| W4 | IN PROGRESS | passive A/B/A trace qualified and exact SHA frozen; awaiting CR15/0.5A heavier real step |
