...
```text
STATE_VERSION=76
UPDATED_AT=2026-09-06T00:42:53+08:00
MASTER_STATUS=IN_PROGRESS__W4_SUPPLEMENTAL_SWEEP_V2_PHYSICAL_CR20_CONFIRMED__ARMED_FOR_ONE_REAL_FIRE
CURRENT_WORK_ORDER=W4
CURRENT_GATE=W4_SUPPLEMENTAL_CR20_TO_CR5_V2_REAL_ARMED
CURRENT_CHECKPOINT=V2_RUN0x25090601_SHA_D1028493__USER_CONFIRMED_CR20_AT00H42M53__VIN24_INPUT1P2A_CARRIED_FORWARD__NOT_FIRED_AT_THIS_CHECKPOINT
LAST_VERIFIED_WORK_ORDER=W3__W4_CR10_INSERTION_COMPLETE
NEXT_ACTION=Fire V2 SHA D1028493 once now, relay CR19-to-CR5 local timed cues every 5s, then read terminal capsule and arrays after the 105s bounded probe.
BOARD_LAST_STATE=V1_AUTONOMOUS_TERMINAL_PWM0_OST1_TZINT0_FAULT0__VIN24_AND_INPUT1P2A_LAST_CONFIRMED__USER_NOW_CONFIRMED_CR20__XDS_IDENTITY_PASS__DEBUG_PROCESS0
PHYSICAL_ACTION_REQUIRED=FOLLOW_CR19_TO_CR5_CUES_EVERY5S__NO_OTHER_ACTION_UNLESS_ESTOP_NEEDED
