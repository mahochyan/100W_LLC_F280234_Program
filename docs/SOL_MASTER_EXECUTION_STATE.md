...
CURRENT_CHECKPOINT=W2_CANDIDATE4_REAL_2MS_FAILED_THREE_TIMES__CR15_500MA_CC_LOADOFF__COMP_TZ1__PRE_BRAKE_HIGH_ABORT__NO_RETRY__NEXT_LOAD_NONE
...
| W2 | BLOCKED | Candidate4 REAL 2MS failed three times (CR15/500mA CC/load off): COMP_TZ1 + pre-brake high abort; no retry; next load NONE |
