...
```text
STATE_VERSION=78
UPDATED_AT=2026-09-06T01:00:00+08:00
MASTER_STATUS=IN_PROGRESS__W4_V2_SAFE_ACTUAL_CR20_TO_CR8_BUT_PHYSICAL_LABELS_INVALID__FORMAL_W4_PI_PFM_GATE_DEFERRED__PROTECTED_BURST_RETURN_V15_OFFLINE_BUILD
CURRENT_WORK_ORDER=W4
CURRENT_GATE=W4_PROTECTED_BURST_CR12_TO_CR15_RETURN_V15_OFFLINE_QUALIFICATION__ORIGINAL_PI_PFM_TOKEN_NOT_ISSUED
CURRENT_CHECKPOINT=V2_RUN0x25090601_SHA_D1028493_FIRED_ONCE__SAFE_COMPLETE400BINS__VOUT5PCT_PASS__USER_CONFIRMED_ACTUAL_ONLY_CR20_TOCR8__TICK_NORMALIZED_LAST_DEMAND38985__SCHEDULED_LABELS_INVALID__DO_NOT_RETRY
LAST_VERIFIED_WORK_ORDER=W3__W4_CR10_INSERTION_COMPLETE
NEXT_ACTION=Complete and offline-qualify a distinct V15 protected-Burst CR12-to-CR15 lighter return with no stdin acknowledgement dependency and explicit PI-inactive/controller metadata; only then request CR12 and 0.5 A once, fire once, return CR15, and continue the W5 reference ladder to find the first continuous-PFM point for a genuine PI A/B/A.
...
PHYSICAL_ACTION_REQUIRED=NONE_DURING_V15_OFFLINE_BUILD_AND_TEST__KEEP_CR8_UNCHANGED
