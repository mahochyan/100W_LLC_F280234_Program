...
```text
STATE_VERSION=59
UPDATED_AT=2026-09-05T11:48:05+08:00
MASTER_STATUS=IN_PROGRESS__REAL_POWER_OFF__XDS_USB_PATH_DISCONNECTED__PHYSICAL_PROBE_REPLUG_REQUIRED
CURRENT_WORK_ORDER=W4
CURRENT_GATE=W4_V13_CR12_TO_CR15_REAL_AFTER_PROBE_RECOVERY_AND_ON_TARGET_NE
CURRENT_CHECKPOINT=W4_V13_CR15_CR12_PROFILE_BOUND_NEW_SHA__REAL_AND_NE_BUILD_PASS__STATIC_AND_W5_HASH_GATES_PASS__REAL_POWER_OFF__XDS_AND_UPSTREAM_HUB_PHANTOM
LAST_VERIFIED_WORK_ORDER=W3__W4_CR10_INSERTION_COMPLETE
NEXT_ACTION=With real 24V off, operator physically replugs XDS or moves it to a direct motherboard USB port; locally enumerate, load V13 no-energy image and verify PWM0/OST1/TZINT0, then request 24V on for CR12-to-CR15 LIGHTER run.
BOARD_LAST_STATE=REAL_24V_OFF__ELOAD_CR12__INPUT_LIMIT0P5A_CARRIED_FORWARD__TARGET_STATE_UNKNOWN_AFTER_DEBUG_LOSS__DSS_PROCESS_EXITED__XDS_COMPOSITE_AND_UPSTREAM_HUB_PRESENT_FALSE_PHANTOM
PHYSICAL_ACTION_REQUIRED=KEEP_24V_OFF__REPLUG_XDS_USB_OR_MOVE_TO_DIRECT_MOTHERBOARD_PORT__KEEP_ELOAD_CR12__NO_DISCHARGE_REASK
...
W4_V13_ON_TARGET_NE=PENDING_PROBE_RECOVERY
...
NEXT=KEEP24V_OFF__PHYSICALLY_REPLUG_XDS__RUN_V13_ON_TARGET_NOENERGY__THEN_POWER_ON_CR12_AND_RUN_LIGHTER_TO_CR15
```
