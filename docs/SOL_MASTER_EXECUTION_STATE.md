...
```text
STATE_VERSION=33
UPDATED_AT=2026-09-05T01:13:05+08:00
MASTER_STATUS=IN_PROGRESS
CURRENT_WORK_ORDER=W4
CURRENT_GATE=W4_USER_REQUESTED_CR10_10V_STRESS_REAL_2S
CURRENT_CHECKPOINT=W4_CR10_REAL_500MS_PASS__SAME_V8_SHA_READY_FOR_2S
LAST_VERIFIED_WORK_ORDER=W3
NEXT_ACTION=Run exact V8 binary at user-confirmed CR10 for 2s; on PASS continue 10s then 60s.
BOARD_LAST_STATE=AFTER_W4_CR10_REAL_500MS_PASS__PWM0_OST1_TZINT0
...
NEXT=CR10_REAL_2S__then_10S_60S_only_after_each_PASS
```
