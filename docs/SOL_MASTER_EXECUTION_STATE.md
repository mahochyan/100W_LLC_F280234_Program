...
```text
STATE_VERSION=56
UPDATED_AT=2026-09-05T10:51:38+08:00
MASTER_STATUS=IN_PROGRESS__REAL_POWER_OFF__OFFLINE_ROOT_CAUSE
CURRENT_WORK_ORDER=W4
CURRENT_GATE=W4_V12_DEBUG_LINK_INDEPENDENT_CAPTURE_DESIGN
CURRENT_CHECKPOINT=W4_V11_HEAVIER_INVALID_UNVERIFIED__LOAD_REMAINED_CR15_NO_STEP__FTDI_MINUS150__OPERATOR_POWER_OFF_CONFIRMED__STUCK_HOST_TERMINATED_WITHOUT_TARGET_HALT
LAST_VERIFIED_WORK_ORDER=W3__W4_CR10_INSERTION_COMPLETE
NEXT_ACTION=With real power off, qualify a new-SHA V12 capture path that does not continuously poll FTDI during switching and cannot actively halt an unconfirmed target; then run no-energy probe diagnostics before requesting power-on.
BOARD_LAST_STATE=REAL_POWER_EXTERNALLY_OFF_CONFIRMED__ELOAD_CR15_CONNECTED__TARGET_DEBUG_STATE_UNVERIFIED_AFTER_HOST_PROCESS_TERMINATION
PHYSICAL_ACTION_REQUIRED=NONE_DURING_OFFLINE_ROOT_CAUSE__KEEP_REAL_POWER_OFF__KEEP_ELOAD_CR15__NO_DISCHARGE_REASK
