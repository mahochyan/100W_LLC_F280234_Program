...
CURRENT_CHECKPOINT=W2_CANDIDATE3_TIMINGFIX5_ALL_NOPOWER_GATES_PASS__UNIQUE_CR15_REAL_LADDER_NEXT
LAST_VERIFIED_WORK_ORDER=W1
NEXT_ACTION=Execute the unique new-SHA CR15 real 2/10/100ms ladder automatically; stop on first failed duration, otherwise close W2 and continue W3.
...
W2_REAL_RETRY_ALLOWED=1_UNIQUE_NEW_SHA_CANDIDATE3_TIMINGFIX5__STANDING_CR15_CONFIRMATION_ACTIVE
