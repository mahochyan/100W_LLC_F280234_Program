...
```text
STATE_VERSION=2
UPDATED_AT=2026-08-25T23:47:03+08:00
MASTER_STATUS=READY_FOR_UNIQUE_REAL_ATTEMPT
CURRENT_WORK_ORDER=W2
CURRENT_GATE=W2_CANDIDATE2_NEW_SHA_CR15_REAL_LADDER
CURRENT_CHECKPOINT=W2_CANDIDATE2_ALL_NOPOWER_GATES_PASS__STANDING_CR15_AUTH_ACTIVE__REAL_LADDER_READY
LAST_VERIFIED_WORK_ORDER=W1
NEXT_ACTION=Execute candidate2 unique CR15 2ms -> 10ms -> 100ms real ladder now; stop safely on the first failed duration.
...
W2_REAL_RETRY_ALLOWED=1_UNIQUE_ATTEMPT_FOR_NEW_SHA_CANDIDATE2
