...
`C:\Users\lapyin\Downloads\100W_LLC_SOL_MAX_一条龙总控工作单_2026-08-25.txt`
(the originally named `.md` path is no longer present).
...
```text
STATE_VERSION=89
UPDATED_AT=2026-09-06__OPERATOR_CONFIRMED_W9_INSTRUMENTS_UNAVAILABLE
MASTER_STATUS=HARD_STOP_INSTRUMENTATION_REQUIRED__SAFE_PROGRESS_FROZEN__NO_50W_VALIDATION_CLAIM
CURRENT_WORK_ORDER=W5
CURRENT_GATE=W9_SCOPE_PRIMARY_CURRENT_GATE_DEADTIME_ZVS_COMPARATOR_TZ_TIMING_REQUIRED_BEFORE_ANY_NEW_REAL_FIRE
CURRENT_CHECKPOINT=W5_ATTEMPTS_0x1A_TO0x1F_PROVE_CR15_SUSTAINABLE_POWER_OVERLAPS_UNBLANKED_PACKET_TURNON_TZ_BOUNDARY__FINAL_TRIP_AT_CYCLE4_DB110_AFTER259_PACKETS
LAST_VERIFIED_WORK_ORDER=W4_ENGINEERING_CLOSED_WITH_EXPLICIT_DEVIATION__W5_OFFLINE_AND_NO_ENERGY_QUALIFICATION_COMPLETE
NEXT_ACTION=INSTALL_SCOPE_PROBES_PER_W9__CAPTURE_TURNON_PRIMARY_CURRENT_GATE_ZVS_AND_TZ__THEN_ARCHITECTURE_DECISION__NO_REPLAY_EXISTING_SHA
BOARD_LAST_STATE=CPU_HALTED__FINAL_PWM0__OST1__FAULT0x10__HARDWARE_ACTIVE_WINDOW_TZ_PROTECTED
PHYSICAL_ACTION_REQUIRED=NONE_AVAILABLE_NOW__OPERATOR_CONFIRMED_NO_W9_SCOPE_CURRENT_PROBE_SETUP__BORROW_RENT_OR_ACQUIRE_BEFORE_CONTINUING_REAL_POWER
HOST_WORKFLOW_ON_RESUME=DO_NOT_FIRE__READ_STATE_AND_EVIDENCE__PREPARE_W9_CAPTURE_ONLY
...
ORIGINAL_TOKEN_LEDGER=W0_ISSUED__W1_SUBSTANTIVE_CLOSURE_EXACT_TOKEN_NOT_ARCHIVED__W2_NOT_ISSUED_CLOSED_WITH_DEVIATION__W3_STRING_ISSUED_BUT_LITERAL_BURST0_AND_EXTERNAL_READING_GATES_MISMATCH__W4_DEFERRED_PERMANENT_WITH_ACCEPTED_DEVIATION__W5_NOT_ISSUED__W6_TO_W8_AND_W10_TO_W14_NOT_ISSUED
W4_ITERATION_RULE_STATUS=RESOLVED_BY_AUDIT_OPTION_B_ACCEPTED__TRACE_GATE_HARD_STOPPED_PER_RULE6_ALLOWANCE__FIVE_ROOT_CAUSE_ITERATIONS_V9_TO_V14_RECORDED_AS_PERMANENT_PROCESS_DEVIATION__NO_FURTHER_10V_TRACE_OR_RETURN_LEG_FIRES__SEE_docs/W4_ITERATION_LEDGER_AUDIT_PROPOSAL_V1.md
FIFTY_WATT_SCOPE=WORK_ORDER_P50_IS12V_4P0A_APPROX48W__EXACT50W_REQUIRES_ADDITIONAL12V_APPROX4P17A_EQUIVALENT2P88OHM_POINT__W10_30S_SHORT_STABILITY__W13_GE2H_ENDURANCE
...
HISTORICAL_W2_SOL_MASTER_EXECUTION_ENGINEERING_BLOCKED=FALSE__NEW_ROOT_CAUSE_CHANGE=REMOVE_COLD_PACKET_RESTART__CONTINUOUS_LIVE_TAKEOVER_TO_170K_EXACT_PACKET
...
| W1 | CLOSED / SUBSTANTIVE PASS | ADC freshness root cause and cadence gates closed; exact master token `W1_ADC_FRESHNESS_FIXED` is not archived as an observed evidence token |
| W2 | CLOSED WITH DEVIATION | Original continuous-PFM token not issued; physical mismatch characterized and protected-Burst live-takeover 1/2/3/5C REAL ladder closed |
| W3 | CLOSED WITH EXPLICIT DEVIATION | Protected-Burst V8 60 s evidence and token string exist, but literal Burst=0 and external input-current/temperature gates were not met |
| W4 | CLOSED WITH DEVIATION (v83) | audit Option B accepted: trace gate hard stopped per rule-6 allowance; original active-PI/PFM token deferred permanently; V14 protected-Burst plant evidence frozen; V15 unchanged (fired once, coordination invalid, capsule lost, no replay) |
...
## W4 V14 user pause after Vin24 enable

```text
W4_V14_PAUSE_TIME=2026-09-05T23:23:28+08:00
W4_V14_PAUSE_PHYSICAL=USER_CONFIRMED_VIN24_ON_AFTER_EXACT_CR15_INPUT_LIMIT0P5A_REQUEST
W4_V14_PAUSE_CAUSAL_ORDER=POWER_ON_CONFIRMATION_THEN_USER_PAUSE__PAUSE WON
W4_V14_PAUSE_EXECUTION=NO_DSS_REAL_COMMAND_STARTED__NO_LOADPROGRAM__NO_POWER_REQUEST__NO_LOAD_STEP
W4_V14_PAUSE_TUPLE=HEAVIER0x2509059A_CR15_TO_CR12__UNFIRED__SAME_SHA_ALLOWED
W4_V14_OPERATOR_FRICTION_POLICY=ELIMINATE_REPEATED_REVIEWS_AND_REDUNDANT_PHYSICAL_CONFIRMATIONS__PRESERVE_ONLY_REQUIRED_LOAD_MOVEMENT_AND_EXISTING_FIRMWARE_PROTECTIONS
NEXT_ON_RESUME=QUICK_XDS_IDENTITY_ONLY__START_HEAVIER_IMMEDIATELY__WAIT_YELLOW__ASK_ONCE_FOR_CR12__SEND_NONCE__AUTONOMOUS_CAPTURE
```

## W4 V14 heavier target PASS with host non-TTY ACK invalidation

```text
W4_V14_HEAVIER_REAL_ATTEMPT_COUNT=1_FIRED_FOR_SHA_B4371EC6
W4_V14_HEAVIER_RUN=0x2509059A__CR15_TO_CR12__PREFIRE_CLOCK10367
W4_V14_HEAVIER_HOST_DEFECT=EXEC_COMMAND_STARTED_WITHOUT_TTY__STDIN_CLOSED__OPERATOR_CR12_CONFIRMATION_COULD_NOT_DELIVER_NONCE__ACK_DEADLINE160S_EXPIRED
W4_V14_HEAVIER_TARGET_TERMINAL=STATE4_REASON1_ELAPSED3000000__PACKET0_PWM0_FINALOST1_HWOST1_FAULT0__COOKIE0x724C0E83_MATCH
W4_V14_HEAVIER_HOLD=MIN1209_MAX1278_AVG1238__PACKETS28003__CYCLES4238046
W4_V14_HEAVIER_TRACE=STATE5_FAIL0__MARKER600074__TRIGGER2724580__MIN1217_MAX1261__SETTLE0MS__QUALITY1
W4_V14_HEAVIER_DEMAND=BASE26475__B1_31284__B2_31284__B3_31561__POST200MS30369
W4_V14_HEAVIER_TARGET_GATES=ALL_PASS__DURATION_DIRECTION_MARKER_GUARD_TELEMETRY_PERSISTENCE_PEAK_SETTLE_RING_AVERAGE_ENERGY_NOFAULT_NOTRIP_NOENABLE_COOKIE_FINALSAFE
W4_V14_HEAVIER_FORMAL_RESULT=TARGET_AND_PLANT_PASS__HOST_ACK_CHAIN_FAIL__SOL_PASS_FALSE
W4_V14_HEAVIER_RETRY_POLICY=NO_RETRY_SAME_SHA_AFTER_FIRE
W4_V14_HEAVIER_EVIDENCE=evidence/sol_master_execution/w4_10v_quality/real_v14_heavier_target_pass_host_ack_invalid_v1.txt
W4_USER_NEW_SWEEP=CR20_TO_CR5__EXACT1_OHM_STEPS__CONTINUOUS_RECORD__NO_PER_POINT_CONFIRMATION
W4_USER_SWEEP_PHYSICAL=VIN24_ON__CR20_CONFIRMED__WAITING_ONE_START_SIGNAL
W4_USER_SWEEP_SCOPE=SUPPLEMENTAL_PLANT_LOAD_MAP__DOES_NOT_REPLACE_REQUIRED_V14_RETURN_DIRECTION_OR_LATER_W9_W10_POWER_EVIDENCE
NEXT=NEW_COMPILE_BOUND_SWEEP_ALGORITHM_AND_RUN_ID__TARGET_SIDE_BUFFER__NO_STDIN__OFFLINE_BUILD_AND_MODEL__THEN_ONE_START_SIGNAL
```

## W4 supplemental CR20-to-CR5 recorder offline qualification

```text
W4_SWEEP_SCOPE=SUPPLEMENTAL_MONOTONIC_16_LEVEL_MAP__NOT_W4_A_B_A_OR_W9_W10_ACCEPTANCE
W4_SWEEP_TUPLE=RUN0x2509059C__DIRECTION3__PROFILE0x1405__ALGORITHM0x0015__CR20_TO_CR5_EXACT1OHM_SCHEDULE
W4_SWEEP_SOURCE_COMMIT=c1e99ce941268b0544bcaa701b318767c64682df
W4_SWEEP_REAL_SHA256=AEF6083F6E08BC65689F86F7F67FF6DCDB3D6409C8219F5C1FA7C1FAAF0A09AA
W4_SWEEP_REAL_MAP_SHA256=D4BB79C8300C3AB2BAFED9A2267BDFB79E730EC587DD7A3449A78CEBE5F371C8
W4_SWEEP_NE_SHA256=17762888AF16B43D98DA9D5975189BF25B43BA95AA9CF7456EA0E8797346964D
W4_SWEEP_NE_MAP_SHA256=B1330EA0A8649496726EAD389B2D3D91FA0E79D9BE79E884BDACA01BCCCCA6B1
W4_SWEEP_MEMORY=6_X_480_UINT16_ARRAYS_2880WORDS_IN_RAML3__REAL_FREE0x1A0__NE_FREE0x15D
W4_SWEEP_PROTOCOL=12S_FIRST_YELLOW_KEEPCR20__15_OFF_BLINKS_EVERY3S__EACH_BLINK_DECREASE1OHM__1S_TRANSITION_PLUS2S_PLATEAU__FINISH60S
W4_SWEEP_CAPTURE=TARGET_480_X100MS_BINS__RAWMIN_RAWMAX_RAWAVG_CYCLES_PACKETS_TICKDELTA__ROLLING_CHECKSUM__TERMINAL_COOKIE_BINDS_COUNT_OVERFLOW
W4_SWEEP_HOST=NO_STDIN_OR_POINT_ACK__NO_ACTIVE_JTAG_POLL__70S_THEN205S_BOUNDED_STATUS__POST_TERMINAL_BULK_READ_AND_FIXED_CSV
W4_SWEEP_HOST_QUALITY=ALL_BIN_STRUCTURE__ALL_TICK4500_TO5500__16_PLATEAUS__HALF_PLATEAU_WITHIN3PCT__15_MONOTONIC_STEPS__ENDPOINT_GE2P5X__VOUT5PCT_AND_ALL_EXISTING_SAFETY_GATES
W4_SWEEP_STATIC=SOL_W4_SWEEP_STATIC_MODEL_PASS__ALL_TRUE__NEGATIVE_MUTATIONS_REJECTED
W4_SWEEP_REGRESSIONS=W4_TRACE_PASS__W3_BURST_HOLD_PASS__W2_LIVE_TAKEOVER_PASS
W4_SWEEP_FINAL_AUDITS=IMPLEMENTATION_GO_P0_0__BINARY_LINK_DISASSEMBLY_GO_P0_0__FINAL_GATE_GO_P0_0
W4_SWEEP_BINARY_AUDIT=ARRAYS_NONOVERLAP__REAL_HARDSTOP_COOKIE_DINT_ESTOP_SPIN__NE_HARDSTOP_COOKIE_RETURN__GPIO_CUES_REAL_ONLY__CONTROL_AND_PROTECTION_DISASSEMBLY_IDENTICAL
W4_SWEEP_CANONICAL_INCIDENT=OFFLINE_NONFIRED_COUNTERFACTUAL_REBUILD_OVERWROTE_IGNORED_V14_BUILD_DIRS__NO_DSS_OR_TARGET_ACTION
W4_SWEEP_CANONICAL_RECOVERY=NONFIRED_REBUILDS_QUARANTINED__CANONICAL_PATHS_ABSENT__V14_HOST_STILL_LOCKS_B437__REPLAY_GUARD_PASS
W4_SWEEP_CANONICAL_TEST_NOTE=OLD_V14_ARTIFACT_REPLAY_TEST_IS_NOW_INTENTIONALLY_NONRUNNABLE_WITH_PATH_ABSENT__HISTORICAL_PASS_RETAINED__NEW_SWEEP_TEST_ALL_GREEN
W4_SWEEP_XDS_PREFIRE=COMPOSITE_MI00_MI01_ALL_PRESENT_OK__UNIQUE_XDS100V2_ROW__SERIAL_EXIT0__DEBUG_PROCESS0__INSTANCE_SUFFIX_REFRESHED_TO7_AND_210704E0
W4_SWEEP_REAL=NOT_FIRED__NO_SAME_SHA_RULE_NOT_YET_CONSUMED
W4_SWEEP_PHYSICAL=VIN24_ON__CR20__INPUT_LIMIT1P2A_ACCEPTED__EARLIER_USER_EXPLICITLY_SAID_ADJUSTED1P2__LATEST_USER_SAID_ALREADY_ON
W4_SWEEP_EVIDENCE=evidence/sol_master_execution/w4_10v_quality/offline_cr20_to_cr5_sweep_v1.txt
NEXT=FIRE_ONCE_SHA_AEF6083F__FOLLOW_LED_BLINKS_CR19_TOCR5__AUTONOMOUS_TERMINAL_AND_BULK_READ
```

## W4 supplemental sweep V1 safe terminal, invalid flat-demand capture

```text
W4_SWEEP_V1_ATTEMPT=1_FIRED_FOR_SHA_AEF6083F__NO_SAME_SHA_RETRY
W4_SWEEP_V1_TUPLE=RUN0x2509059C__PROFILE0x1405__ALGORITHM0x0015__DIRECTION3
W4_SWEEP_V1_PREFIRE=ALL_PASS__TARGET_CLOCK10485_PER200MS
W4_SWEEP_V1_TERMINAL=70S_HALTED_TRUE__STATE4_REASON1_ELAPSED3000069__TRACE5_FAIL0__COUNT480_OVERFLOW0
W4_SWEEP_V1_INTEGRITY=CHECKSUM0x6C75B0C2_MATCH__COOKIE0x1FDBA54F_MATCH
W4_SWEEP_V1_SAFETY=PWM0_OST1_TZINT0_FAULT0__NO_HARDLIMIT_HWTRIP_PUBLICENABLE
W4_SWEEP_V1_VOUT=RAW1213_TO1265__ALL16_PLATEAUS_STABLE_AND_IN5PCT
W4_SWEEP_V1_DEMAND=FIRST21775__LAST21878__RATIO1P00473__MONOTONIC_STEPS0OF15
W4_SWEEP_V1_FAILED_GATES=15_MONOTONIC_STEPS__ENDPOINT_GE2P5X
W4_SWEEP_V1_RESULT=FAIL_INVALID_NO_EFFECTIVE_LOAD_CHANGE__NOT_CONTROL_OR_SAFETY_FAILURE
W4_SWEEP_V1_CSV=evidence/sol_master_execution/w4_10v_quality/cr20_to_cr5_sweep_run_0x2509059c.csv__SHA14BB461669C0A02541570CC29C1C15C5B949B69F2088C0C3A292F48DBC8AC37C
W4_SWEEP_V1_EVIDENCE=evidence/sol_master_execution/w4_10v_quality/real_cr20_to_cr5_sweep_v1_no_effective_load_change.txt
NEXT=NEW_TARGET_SHA_RUN_AND_ALGORITHM__5S_LEVELS__VISIBLE_LONG_LED_AND_HOST_TIMED_CUES__NO_ACTIVE_JTAG
```

## W4 supplemental sweep V2 visible-cue offline qualification

```text
W4_SWEEP_V2_SCOPE=SUPPLEMENTAL_MONOTONIC_16_LEVEL_MAP__NOT_FORMAL_W4_A_B_A_OR_W9_W10_ACCEPTANCE
W4_SWEEP_V2_SOURCE_COMMIT=e62916edb18535d00bcd14c0edf4ecf23cba3e51
W4_SWEEP_V2_TUPLE=RUN0x25090601__DIRECTION3__PROFILE0x1405__ALGORITHM0x0016__CHECKSUM_SEED0x53575016
W4_SWEEP_V2_TIMING=12S_TARGET_MARKER__16_LEVELS_X5S__15_CUES_EVERY5S__3S_TRANSITION_PLUS2S_PLATEAU__TARGET_COMPLETE4600000TICKS_APPROX92S
W4_SWEEP_V2_TARGET_CUE=FIRST_YELLOW_KEEPCR20__COUNT25_TO375_OFF_CUES__8_X200MS_EQUALS1P6S__NO_OFF_BY_ONE
W4_SWEEP_V2_HOST_CUE=LOCAL_TEXT_AND_BEEP_FIRST_FIRE_PLUS17P2S_THEN5S_X15__TARGET_LED_AUTHORITATIVE__NO_DSS_OR_JTAG_UNTIL105S__FALLBACK205S
W4_SWEEP_V2_CAPTURE=TARGET_400_X200MS_BINS__SIX_ARRAYS2400WORDS__RAWMIN_RAWMAX_RAWAVG_CYCLES_PACKETS_TICKDELTA__ROLLING_CHECKSUM_AND_BOUND_COOKIE
W4_SWEEP_V2_REAL_OUT_SHA256=D10284938BE15DEA5772DF8595F064E40321B2BF26898CED382DE0ABD2C3A8CD
W4_SWEEP_V2_REAL_MAP_SHA256=442B64AA26B0801A3D6CF9D24F474159BE56C6683A77DDE9FE6C18BEF4D40562
W4_SWEEP_V2_NE_OUT_SHA256=54376784D0143087545CE458E2B8B80455396F2909DE548771E7A24F99375FB6
W4_SWEEP_V2_NE_MAP_SHA256=FD284C93CC720174F432D30B960CB67E8E463A20D6D99FD243A18FB648A22140
W4_SWEEP_V2_LOADABLE_REPRO_SHA=REAL9E5854B2F98637A65A462B2BDBF0ED280A3B4E6FCD7BBCF63F0C909008741148__NE734877F716038EAFA2EE803C73EB993087396245FEAC86C8A71A12D667ABAC2C
W4_SWEEP_V2_MEMORY=REAL_RAML1_FREE0x340_RAML2_FREE0x5C_RAML3_FREE0x320__NE_RAML1_FREE0x340_RAML2_FREE0x1_RAML3_FREE0x2ED__SIX_ARRAYS_NONOVERLAP
W4_SWEEP_V2_V1_ISOLATION=V1_REAL_AEF6083F_MAPD4BB79C8_NE17762888_MAPB1330EA0_ALL_UNCHANGED__OLD_SOL_W4_SWEEP_BUILD_EXIT2__V2_DISTINCT_DIRECTORIES
W4_SWEEP_V2_REPRO=ISOLATED_REAL_AND_NE_REBUILD_PASS__LOADABLE_SECTIONS_BYTE_IDENTICAL__RAW_COFF_SHA_PATH_DEPENDENT_ONLY_DUE_DEBUG_METADATA
W4_SWEEP_V2_STATIC=SOL_W4_SWEEP_STATIC_MODEL_PASS__NEGATIVE_MUTATIONS_REJECTED__NODE_CHECK_AND_PYCOMPILE_PASS
W4_SWEEP_V2_REGRESSIONS=SOL_W4_TRACE_STATIC_MODEL_PASS__SOL_W3_10V_BURST_HOLD_STATIC_PASS__SOL_W2_LIVE_TAKEOVER_PACKET_STATIC_PASS__W5_PREFLIGHT_AND_MODULE_PASS
W4_SWEEP_V2_V14_REPLAY_GUARD=CANONICAL_FOUR_PIECE_ALL_ABSENT_OR_ALL_EXACT__MIXED_OR_WRONG_SHA_NEGATIVE_MODELS_REJECTED
W4_SWEEP_V2_AUDITS=IMPLEMENTATION_GO_P0_0_P1_0__ARTIFACT_GO_NO_BLOCKER
W4_SWEEP_V2_OFFLINE_TARGET_ACCESS=NONE__BOARD_REMAINS_V1_SAFE_TERMINAL_PWM0_OST1_TZINT0_FAULT0
W4_SWEEP_V2_REAL=NOT_FIRED__SHA_D1028493_AVAILABLE_FOR_ONE_ATTEMPT
W4_SWEEP_V2_PHYSICAL=VIN24_AND_INPUT_LIMIT1P2A_LAST_CONFIRMED__ASK_CURRENT_CR20_ONCE_ONLY
W4_SWEEP_V2_EVIDENCE=evidence/sol_master_execution/w4_10v_quality/offline_cr20_to_cr5_sweep_v2.txt
NEXT=CONFIRM_CR20_ONCE__QUICK_XDS_IDENTITY__FIRE_D1028493_ONCE__RELAY_CR19_TOCR5_CUES
```

## W4 supplemental sweep V2 physical arm

```text
W4_SWEEP_V2_ARM_TIME=2026-09-06T00:42:53+08:00
W4_SWEEP_V2_ARM_PHYSICAL=USER_CONFIRMED_CR20__VIN24_AND_INPUT_LIMIT1P2A_CARRIED_FORWARD_UNCHANGED
W4_SWEEP_V2_ARM_HOST=XDS100V2_ENUMERATED__DEBUG_PROCESS0__REAL_SHA_D1028493_BOUND
W4_SWEEP_V2_ARM_FIRE_STATE=NOT_FIRED_AT_CHECKPOINT__ONE_ATTEMPT_AVAILABLE
NEXT=FIRE_NOW__RELAY_CR19_TOCR5_EVERY5S__NO_ACTIVE_WINDOW_JTAG
```

## W4 supplemental sweep V2 real result: safe, actual endpoint CR8

```text
W4_SWEEP_V2_ATTEMPT=1_FIRED_FOR_SHA_D1028493__NO_SAME_SHA_RETRY
W4_SWEEP_V2_TUPLE=RUN0x25090601__PROFILE0x1405__ALGORITHM0x0016__DIRECTION3
W4_SWEEP_V2_PREFIRE=ALL_PASS__TARGET_CLOCK10326_PER200MS
W4_SWEEP_V2_TERMINAL=105S_HALTED_TRUE__STATE4_REASON1_ELAPSED4627518__TRACE5_FAIL0__COUNT400_OVERFLOW0
W4_SWEEP_V2_INTEGRITY=CHECKSUM0x0DD05003_MATCH__COOKIE0x7E0E4610_MATCH__CAPTURE_TICKS4027477
W4_SWEEP_V2_SAFETY=PWM0_OST1_TZINT0_FAULT0__NO_HARDLIMIT_HWTRIP_PUBLICENABLE
W4_SWEEP_V2_VOUT=RAW1192_TO1270__GLOBAL5PCT_PASS
W4_SWEEP_V2_OPERATOR_TRUTH=USER_CONFIRMED_ONLY_REACHED_CR8__NOT_CR5__SCHEDULED_CR_LABELS_AND16_PLATEAU_CLAIM_INVALID
W4_SWEEP_V2_DEMAND=FIRST_SCHEDULED21384__LAST_SCHEDULED49680__QUALITATIVE_INCREASE_ONLY__ENDPOINT_GATE_LT2P5X
W4_SWEEP_V2_CADENCE=FIRST_BAD_BIN391__9_BINS_ABOVE11000__MAX13202__LAST_SCHEDULED_PLATEAU_UNSTABLE
W4_SWEEP_V2_FAILED_GATES=CADENCE__16_PLATEAUS__15_MONOTONIC_STEPS__DURATION92S__ENDPOINT_GE2P5X
W4_SWEEP_V2_RESULT=FAIL_INVALID_COORDINATION_AND_INCOMPLETE_PHYSICAL_SWEEP__NOT_CONTROL_OR_SAFETY_FAILURE
W4_SWEEP_V2_CSV=evidence/sol_master_execution/w4_10v_quality/cr20_to_cr5_sweep_v2_run_0x25090601.csv__SHACD57593E583D27124AE49C612D508DBFFCC48E75BC4631827E515ACC103E93B4
W4_SWEEP_V2_EVIDENCE=evidence/sol_master_execution/w4_10v_quality/real_cr20_to_cr8_sweep_v2_coordination_invalid.txt
W4_SWEEP_V2_PHYSICAL_NOW=VIN24__INPUT_LIMIT1P2A__ELOAD_CR8__HOLD_UNCHANGED_DURING_OFFLINE_FIX
NEXT=NEW_V3_SHA_RUN_ALGORITHM__LONGER_LEVELS__VISIBLE_TERMINAL_PLUS_TARGET_LED__NO_ACTIVE_JTAG
```

## W4 control-mode fidelity audit and V2 cadence correction

```text
W4_V2_OPERATOR_CORRECTION=PHYSICAL_ENDPOINT_CR8_ONLY__CR7_CR6_CR5_NEVER_REACHED__NO_POSTHOC_RELABEL
W4_V2_LAST_PLATEAU_RAW_DEMAND=FIRST_HALF48240__SECOND_HALF51120__WHOLE49680
W4_V2_LAST_PLATEAU_TICKS=FIRST_HALF61916__SECOND_HALF65518__WHOLE127434
W4_V2_LAST_PLATEAU_TICK_NORMALIZED=FIRST_HALF38956__SECOND_HALF39012__WHOLE38985
W4_V2_CADENCE_INTERPRETATION=RAW_LAST_HALF_INSTABILITY_WAS_SAMPLE_CADENCE_INFLATION__NORMALIZED_HALVES_STABLE__OHM_LABELS_REMAIN_INVALID
W4_V2_RECORDER_CORRECTION=FUTURE_BINS_CLOSE_ON_ELAPSED_DEADLINE__AVERAGES_USE_ACTUAL_SAMPLE_COUNT__DEMAND_NORMALIZED_BY_ACTUAL_TICKS
W4_SUPPLEMENTAL_V3_DISPOSITION=CANCELLED_BEFORE_BUILD_OR_FIRE__CR8_TO_CR5_WOULD_EXCEED10W_AT10V_AND_REQUIRES_W9_INSTRUMENT_GATE
W4_FORMAL_REQUIREMENT=ACTIVE_CONTINUOUS_PI_PFM__CR15_TO_CR12_ORIGINAL12P5__A_B_A__KP_KI_PEAK_DIP_SETTLE_INTEGRAL_SATURATION_FREQUENCY_TRAJECTORY__ISR_LE900
W4_CURRENT_CONTROL_MODE=PROTECTED_BURST_FIXED250KHZ_TBPRD239__PI_COMPUTE_AND_APPLY_BYPASSED
W4_ORIGINAL_TOKEN=W4_10V_PI_PFM_BASELINE_ACCEPTED__NOT_ISSUED__CANNOT_BE_EARNED_BY_V14_V2_OR_V15_PROTECTED_BURST
HISTORICAL_SUPERSEDED_W4_DEVIATION_PATH=FIRST_CLOSE_PROTECTED_BURST_RETURN_CR12_TO_CR15_WITH_DISTINCT_V15__THEN_W5_REFERENCE_LADDER_AT_CR15_TO_LOCATE_FIRST_CONTINUOUS_PFM_POINT__ALTERNATIVE_CONTROL_QUALITY_EVIDENCE_ONLY__CANNOT_BACKFILL_ORIGINAL_W4_TOKEN
W4_W9_BOUNDARY=NO_FURTHER_GT10W_OR_LOWER_RESISTANCE_SWEEP_WITH_ONCHIP_ADC_ONLY__W9_SCOPE_CURRENT_GATE_DEADTIME_ZVS_TEMPERATURE_AND_POWER_INSTRUMENTS_REQUIRED
W4_V15_PURPOSE=SAFE_LIGHTER_RETURN_AND_BURST_BASELINE_ONLY__EXPLICIT_PI_INACTIVE_METADATA__NO_FALSE_PI_TOKEN
W4_V15_PHYSICAL_REQUEST=DEFERRED_UNTIL_OFFLINE_QUALIFIED__THEN_SET_CR12_AND_INPUT_LIMIT0P5A_ONCE__TARGET_CUE_RETURNS_TO_CR15
NEXT=FINISH_V15_SOURCE_BUILD_NOENERGY_AND_STATIC_QUALIFICATION__DO_NOT_TOUCH_BOARD_DURING_OFFLINE_WORK
```

## W4 protected-Burst return V15 offline qualification

```text
W4_V15_SOURCE_COMMIT=0cf623d64ddc8299d93fb6b37812e2d0d0ef98b8
W4_V15_TUPLE=RUN0x25090602__PROFILE0x0F0C__ALGORITHM0x0017__DIRECTION2_LIGHTER__CR12_TO_CR15
W4_V15_MODE=PROTECTED_BURST__MODE0x42525354__PROFILE0xEFFA6E24__PI_PFM_ACTIVE_FALSE
W4_V15_REAL_OUT_SHA256=A2148D520E8EEDE6C9F060D07B0533E8F0EB799B99C928DED5642EF2D876E5A1
W4_V15_REAL_MAP_SHA256=39528C2320420C2A78A652819DFFF34932B133BE6CC9DAB7B1268C060969F27E
W4_V15_NE_OUT_SHA256=417B533553572D3652AA88AE2B4D3E6FCC78FFDB72B82A07EC5052DA5D56F226
W4_V15_NE_MAP_SHA256=4C614BA99DD2DBA63A2E002816B0DD0CB5E92994F31544E54EB6F88ECADBACD8
W4_V15_BUILD=REAL_AND_NE_EXIT0__ALL_MEMORY_FITS__REAL_RAML2_FREE0x5C__REAL_RAML3_FREE0xD42__NE_RAML2_FREE0x1
W4_V15_BINARY=NM_CTRL_FASTTASK_ABSENT__OPENLOOP_FASTTASK_PRESENT__TINT0_DISASSEMBLY_CALLS_OPENLOOP__EVIDENCE_SYMBOLS_LINKED
W4_V15_HOST=NO_STDIN_NONCE__TARGET_YELLOW_AUTHORITATIVE__LOCAL_CUES12P2_22P2_32P2_42P2_52P2S__NO_DSS_UNTIL70S__MAX2_PROBES70S_AND205S
W4_V15_TARGET=LIGHTER_ONLY__TRACE_SUCCESS_TERMINAL_NOT_BEFORE60S__MISSED_OR_WRONG_STEP_SAFE_BACKSTOP180S__PWM0_OST1
W4_V15_REAL_GATES=PI_UPDATE_AND_INTEGRAL_UNCHANGED__GENERIC_PERIOD_WRITE0__ISR_TINT0_BODY_NONZERO_AND_LE900__OVERRUN0__VOUT5PCT__SETTLE100MS__V14_PLANT_ANCHORS10PCT__SAFETY_AND_COOKIE
W4_V15_TESTS=V15_STATIC_MODEL_PASS__W4_TRACE_PASS__W4_SWEEP_PASS__W3_BURST_HOLD_PASS__W2_LIVE_TAKEOVER_PASS__NODE_CHECK_PASS
W4_V15_FINAL_AUDIT=GO__P0_0__P1_0
HISTORICAL_SUPERSEDED_W4_V15_REAL_STATUS_AT_OFFLINE_QUALIFICATION=NOT_FIRED__ONE_ATTEMPT_AVAILABLE_FOR_EXACT_SHA_A2148D52
W4_V15_SCOPE=PROTECTED_BURST_PLANT_RETURN_ONLY__W4_10V_PI_PFM_BASELINE_ACCEPTED_REMAINS_NOT_ISSUED
W4_V15_OFFLINE_EVIDENCE=evidence/sol_master_execution/w4_10v_quality/offline_cr12_to_cr15_return_v15.txt__SHA427E24762784FDA279440B2BD815BFF816175D8C411F816AFCC7764416601638
HISTORICAL_SUPERSEDED_W4_V15_PHYSICAL_AT_OFFLINE_QUALIFICATION=USER_LAST_CONFIRMED_VIN24__INPUT_LIMIT1P2A__ELOAD_CR8__BOARD_SAFE_TERMINAL
HISTORICAL_SUPERSEDED_W4_V15_NEXT_AT_OFFLINE_QUALIFICATION=SET_CR12_AND_INPUT_LIMIT0P5A_ONCE__CONFIRM__PREFIRE_IDENTITY__FIRE_A2148D52_ONCE__SET_CR15_AT_YELLOW_CUE
```

## W4 V15 CR12 physical setup and quick XDS identity

```text
W4_V15_CR12_CONFIRM_TIME=2026-09-06T11:00:00+08:00
W4_V15_OPERATOR_CONFIRMATION=ELOAD_NOW_CR12
HISTORICAL_SUPERSEDED_W4_V15_INPUT_LIMIT_STATUS_AT_CR12_CONFIRM=0P5A_REQUESTED_BUT_NOT_YET_EXPLICITLY_CONFIRMED__DO_NOT_FIRE_YET
W4_V15_XDS_QUICK_IDENTITY=PASS__COMPOSITE_OK__MI00_OK__MI01_OK__XDS100SERIAL_EXIT0__ONE_UNIQUE0403_A6D0_XDS100V2_ROW
W4_V15_XDS_INSTANCE=USB_VID0403_PID_A6D0_XDS100V2__MI00_7_AND_210704E0_0_0000__MI01_7_AND_210704E0_0_0001
W4_V15_DEBUG_PROCESS_COUNT=0
HISTORICAL_SUPERSEDED_W4_V15_REAL_STATUS_AT_CR12_CONFIRM=NOT_FIRED__EXACT_SHA_A2148D52_REMAINS_AVAILABLE_FOR_ONE_ATTEMPT
HISTORICAL_SUPERSEDED_W4_V15_NEXT_AT_CR12_CONFIRM=CONFIRM_INPUT_LIMIT0P5A__FIRE_WITHOUT_FURTHER_REVIEW__RELAY_CR15_CUE
```

## W4 V15 no-screen host protocol revision and final arm

```text
W4_V15_OPERATOR_DIRECTIVE=BENCH_STAYS_ON__DO_NOT_ASK_READY_AGAIN__CHAT_SCREEN_NOT_VISIBLE_DURING_ELOAD_CONTROL
W4_V15_PHYSICAL=VIN24_CARRIED__ELOAD_CR12_EXPLICIT__INPUT_LIMIT1P2A_CARRIED_FROM_LAST_EXPLICIT_SETTING
W4_V15_POWER_SCOPE=10V_AT_CR12_APPROX8P33W__BELOW10W__CR12_LIGHTER_THAN_PRIOR_SAFE_CR8_AT_SAME1P2A_LIMIT
W4_V15_HOST_ONLY_REVISION=INPUT_ENV_GATE1P2A__AUDIBLE_BEEP_AT8S_AND12P2_22P2_32P2_42P2_52P2S__NO_TARGET_CHANGE
W4_V15_TARGET_SHA_UNCHANGED=A2148D520E8EEDE6C9F060D07B0533E8F0EB799B99C928DED5642EF2D876E5A1
W4_V15_REVISION_TEST=STATIC_MODEL_PASS__NODE_CHECK_PASS
W4_V15_PREFIRE_IDENTITY=COMPOSITE_MI00_MI01_OK__XDS100SERIAL_EXIT0_ONE_ROW__DEBUG_PROCESS0
HISTORICAL_SUPERSEDED_W4_V15_FIRE_STATE_AT_FINAL_ARM=ARMED__NOT_FIRED__RUN_NEXT_WITHOUT_ANOTHER_READY_QUERY
HISTORICAL_SUPERSEDED_W4_V15_NEXT_AT_FINAL_ARM=FIRE_A2148D52_ONCE__OPERATOR_USES_YELLOW_LED_OR_BEEP_TO_SET_CR15__TARGET_AUTONOMOUS_TERMINAL
```

## W4 V15 real attempt, lost capsule, and user-requested pause

This section and `STATE_VERSION=82` supersede every earlier V15
`NOT_FIRED`, `ARMED`, `FIRE_NOW`, and `ONE_ATTEMPT_AVAILABLE` line above.
Those older lines remain only as chronological history and must not be used as
the resume checkpoint.

```text
W4_V15_REAL_ATTEMPT=1_FIRED_FOR_EXACT_SHA_A2148D52__NO_SAME_SHA_RETRY
W4_V15_TUPLE=RUN0x25090602__PROFILE0x0F0C__ALGORITHM0x0017__DIRECTION2_LIGHTER__PROTECTED_BURST
W4_V15_PREFIRE=PASS__INIT_IDLE_PWM0_FAULT0_OST1_TZINT0__LOOPBACK_AND_STAGE1_TO5_PASS__CLOCK_DELTA10538_PER200MS
W4_V15_HOST_CUES=FIRED__8S_WARNING__12P2_22P2_32P2_42P2_52P2S_REPEATED
W4_V15_OPERATOR_EVENT=RESTART_REQUEST_DURING_ACTIVE_WINDOW__PHYSICAL_COORDINATION_INVALID
W4_V15_HOST70S=ISHALTED_FALSE
W4_V15_HOST205S=ISHALTED_FALSE__TERMINAL_UNCONFIRMED__FIRMWARE_TERMINAL_UNCONFIRMED
W4_V15_HOST_FAIL_CLOSED=PASS__NO_HALT__NO_TARGET_WRITE
W4_V15_LATE_ATTACH=ISHALTED_TRUE__ATTACH_ONLY
W4_V15_LATE_CAPSULE=INVALID_OR_LOST__STATE0__REASON0__ELAPSED4230290221__DIRECTION0__RUN0xFCF20389__COOKIE0_MISMATCH__PI_METADATA0
W4_V15_TARGET_RESULT=UNKNOWN__NO_PLANT_PASS__NO_TERMINAL_PASS__NO_PWM0_OST1_CLAIM
W4_V15_REAL_STATUS=FIRED_ONCE__COORDINATION_INVALID__TERMINAL_CAPSULE_LOST__NO_RETRY
W4_V15_SAME_SHA_REPLAY_ALLOWED=FALSE
NO_REPLAY=A2148D520E8EEDE6C9F060D07B0533E8F0EB799B99C928DED5642EF2D876E5A1
W4_ORIGINAL_PI_TOKEN=W4_10V_PI_PFM_BASELINE_ACCEPTED__NOT_ISSUED
W4_ORIGINAL_GATE=ONLY10V__LITERAL_MASTER_LOAD_CR15_TO_CR12P5__USER_AMENDED_OPERATIVE_LOAD_CR15_TO_CR12__NO_BURST__ACTIVE_PI_PFM_ABA__HIGHER_VREF_CANNOT_BACKFILL
W4_ITERATION_LEDGER=V9_TO_V13_ABA_REAL_ATTEMPTS1_TO5_EXCEEDED_THREE_ITERATION_LIMIT__V14_V15_PROPOSED_AS_SEPARATE_PROTECTED_BURST_CLASSIFICATION_BUT_NOT_YET_ACCEPTED__PROCESS_DEVIATION_RECORDED
W4_ITERATION_NEXT=AUDIT_GATE_CLASSIFICATION_FIRST__DO_NOT_SILENTLY_CREATE_V16
W4_V15_LAST_EXPLICIT_CHANGE=ELOAD_CR12
W4_V15_CARRIED_PHYSICAL_CONTEXT=VIN24__INPUT_LIMIT1P2A
W4_V2_INSTRUMENTATION_INCIDENT=CR8_AT10V_APPROX12P5W_RAN_BEFORE_W9__HISTORICAL_PROCESS_DEVIATION__NO_W4_W9_W10_ACCEPTANCE_OR_W9_WAIVER
PAUSE_REASON=USER_REQUESTED__STOP_TESTING_PUSH_AND_REPORT
PAUSE_SAFE_CPU=ALREADY_HALTED
PAUSE_SAFE_HARDWARE=EPWM1ENCLK0__TBCLKSYNC0__GPIO0_AND1_MUX0_DATA0__TBPRD0__TZINT0
PAUSE_SAFE_OST=0__CLOCK_DISABLED_RESET_PATH__DO_NOT_CLAIM_OST1
PAUSE_SAFE_RESET_DEFAULT_PATH=TRUE
PAUSE_SAFE_OUTPUT_GATE=PASS
PAUSE_SAFE_SCOPE=INDEPENDENT_NO_OUTPUT_REGISTER_GATE__NOT_V15_TERMINAL_EVIDENCE
PAUSE_EVIDENCE=evidence/sol_master_execution/w4_10v_quality/real_v15_coordination_invalid_capsule_lost_pause_safe.txt__SHA7CED182F9C029C7F6CF786D0C8A63959F460A8649F76274FF539984D55A7E541
PAUSE_REPORT=docs/SOL_MASTER_PAUSE_REPORT_2026-09-06.md
CURRENT_WORK_ORDER=W5
NO_REDO=W0_W1_W2_W3__W4_TRACE_GATE_PERMANENTLY_CLOSED
NEXT_OPERATOR_ACTION=NONE_UNTIL_USER_RESUME_GO__THEN_W5_OFFLINE_REGRESSION_AND_SINGLE_MESSAGE_BENCH_CONFIRM
NEXT_REAL_REQUIREMENT=FIRST_AUDIT_W4_THREE_ITERATION_RULE_AND_GATE_CLASSIFICATION__ONLY_IF_ALLOWED_NEW_ROOT_CAUSE_RUN_ALGORITHM_SOURCE_COMMIT_OUT_SHA_AND_FULL_OFFLINE_QUALIFICATION
W9_REQUIRED_BEFORE_GT10W_OR_50W=TRUE
```

## W4 iteration audit ruling — Option B accepted (STATE_VERSION=83)

Accepted by the user on 2026-09-06 via `docs/W4_ITERATION_LEDGER_AUDIT_PROPOSAL_V1.md`.

```text
W4_AUDIT=RULE6_THREE_ITERATION_ALLOWANCE_EXERCISED
W4_TRACE_GATE=HARD_STOPPED__NO_FURTHER_10V_TRACE_OR_RETURN_LEG_REAL_FIRES
W4_ORIGINAL_TOKEN=W4_10V_PI_PFM_BASELINE_ACCEPTED__DEFERRED_PERMANENT_WITH_ACCEPTED_DEVIATION__REOPEN_ONLY_VIA_FUTURE_CONTROL_REGION_REDESIGN_WITH_ACTIVE_PI_IN_REAL_INTERRUPT_PATH
W4_DEVIATION_CLOSURE=W4_10V_CONTROL_QUALITY_CLOSED_WITH_PROTECTED_BURST_PLANT_RESPONSE_DEVIATION__STRONGEST_SINGLE_ARTIFACT=real_v14_heavier_target_pass_host_ack_invalid_v1.txt
W4_DEVIATION_BOUNDARY=DEVIATION_TOKEN_IS_NOT_THE_ORIGINAL_TOKEN__CANNOT_BE_EARNED_BY_PROTECTED_BURST__NO_W5_BACKFILL
V15_DISPOSITION=UNCHANGED__FIRED_ONCE__COORDINATION_INVALID__TERMINAL_CAPSULE_LOST__NO_RETRY__SHA_A2148D52_NEVER_REPLAYED
W4_LEDGER_SUMMARY=7_REAL_FIRES_V8_TO_V15__ZERO_PLANT_OR_PROTECTION_ENGINEERING_FAILURES__1_ENG_DETECTION_FAILURE_V13_FIXED_BY_V14__INF_AND_OPS_DOMINANT__PROCESS_DEVIATION_PERMANENT
W4_AUDIT_PROCESS_FIXES=PRE_FIRE_SINGLE_MESSAGE_BENCH_CONFIRM__NO_MID_WINDOW_OPERATOR_ACTIONS__CAPSULE_READ_SAME_SESSION_ONLY__LOAD_AND_LIMIT_MUST_MATCH_OFFLINE_DECLARATION
W5_ENTRY_CONDITIONS=USER_RESUME_GO__THEN_W5_OFFLINE_REGRESSION__THEN_SINGLE_MESSAGE_BENCH_CONFIRM_CR15_AND_INPUT_LIMIT_0P7A__PREFIRE_BASELINE_RECHECK_ONLY_IF_USB_RESET_POWER_OR_TARGET_STATE_CHANGED
W5_CARRYOVER=PROTECTED_BURST_DEVIATION_CONTEXT_FROM_W4__IF_ANY_LADDER_LEVEL_NEEDS_BURST_RECORD_A_W5_DEVIATION_TOKEN__NEVER_THE_ORIGINAL_W5_TOKEN
GIT_NOTE=V83_AUDIT_AND_STATE_UPDATE_NOT_YET_COMMITTED__SESSION_SHELL_DOWN__COMMIT_WHEN_SHELL_RESTORES_OR_VIA_USER_TERMINAL
```

## W5 offline candidate qualified (STATE_VERSION=84)

- USER RESUME GO received (CR15, Vin24V). W5 ladder integration completed and offline-qualified:
  CAL_HOLD_MODE_W5_LADDER on the protected-Burst engine (per-rung 100ms+2s, W5REF-driven
  thresholds, absolute 1640 ceiling replaces fixed 11V guard in W5 image only).
- Frozen SHA tuple: REAL_OUT=63481DBE6A191266ADDB03ED9C89FCF35D20988905E1D58DEFA1965FAF52A99A
  NE_OUT=7277B5AACF64221F28DCA5F51879744E8AB3F5687A5C87E352FE817BAB66248A
...
## W5 attempt 5 diagnosis and attempt 6 candidate qualification (STATE_VERSION=86)

- Attach-only attempt-5 readback proved the comparator helper accepted its settled
  snapshot (`reject=0`, `armed=1`, `GPIO15 snapshot=1`), while the caller's second
  asynchronous GPIO15 read caused reason 8 before `PWM_PrepareStart`; initial charge
  had stopped normally at raw 1202/1200 and no packet or ladder rung ran.
- Algorithm `0x0019` centralizes the decision in `COMP_ArmCommon`: two bounded samples,
  each after 2 us settling, must both be high while OST stays latched. The caller no
  longer repeats the raw GPIO read. Hardware OSHT1 remains armed through the sole
  deterministic release point.
- All four offline suites PASS; REAL and NE clean builds exit 0. On-target NE walk
  PASS: 5/5 rungs, abort 0, cookie `0x57353573`, run ID `0x25090610`, final PWM 0,
  zero TZCLR writes, zero enable rises, OST continuously latched.
- Frozen REAL OUT: `0D1387540A182E94F9DCB63FE63D5FD9E80E00E19A390C7AE175DCFAA9D60FEB`.
  Frozen NE OUT: `F43B769DC4D39B2AD646A687DA01C39C4B539652BD69F3791F6F2B66E0C1B5C3`.
- Evidence: `evidence/sol_master_execution/w5_12v_transition/w5_attempt6_prestart_race_fix_ne_pass.txt`.
- Next: one fresh confirmation of CR15, Vin 24 V, input limit 0.7 A; then fire this
  exact REAL SHA once and read its terminal capsule in the same session. No mid-window
  action and no same-SHA retry after any real abort.
- `W5_REAL_POWER_PASS_CLAIMED=FALSE`.

## W9 instrumentation availability ruling (STATE_VERSION=89)

- Operator confirmed the required oscilloscope/current-measurement equipment is
  not available. Per master work-order sections 3.2 and W9, no further new real
  power fire and no 50--100 W validation claim are permitted.
- This is an instrumentation hard stop, not permission to disable comparator/TZ,
  relax its threshold, or reuse a failed SHA. The last board state remains CPU
  halted, PWM 0, OST 1, with the hardware trip recorded.
- Safe deliverable scope tonight: repository, evidence, bounded low-power results,
  known W5 turn-on/TZ boundary, and an explicitly conditional/unvalidated release.
- Resume this same master task at W9 after suitable instruments are available;
  do not restart W0--W8 and do not recreate work orders.
- `HARD_STOP_INSTRUMENTATION_REQUIRED`.
- `SAFE_PROGRESS_COMPLETE_THROUGH_W4_WITH_ACCEPTED_DEVIATION__W5_NOT_PASSED`.

## W5 CR15 burst/TZ boundary frozen (STATE_VERSION=88)

- Attempts `0x1A..0x1F` isolated start authorization, packet power and recovery.
  DB110-only and 35-cycle/DB100 variants exited undervoltage; stronger variants
  eventually triggered the real hardware active-window TZ and ended PWM0/OST1.
- The decisive `0x1F` trip occurred on packet 259 at cycle 4 while still DB110,
  proving this is packet turn-on/comparator timing, not merely the lower DB floor.
- No listed SHA may be replayed. W5 cannot be advanced safely by software-only
  tuning; W9 scope capture of primary current, gate/deadtime/ZVS and TZ timing is
  required before blanking/filter or continuous-PFM design decisions.
- Evidence: `evidence/sol_master_execution/w5_12v_transition/w5_cr15_burst_boundary_attempts_7_to_11.txt`.
- `W5_REAL_POWER_PASS_CLAIMED=FALSE`.

## W5 real attempt 6 and candidate 7 qualification (STATE_VERSION=87)

- User confirmed CR15, Vin 24 V, input limit 0.7 A. Algorithm `0x0019` passed
  every prefire gate and completed the initial charge, then safely stopped before
  the first recharge packet: state 5/reason 8, packet cycles 0, fault 0, PWM 0,
  final OST 1. Exact SHA `0D138754...` will not be retried.
- Attach-only decode showed comparator authorization fully passed. The actual
  rejection was `PWM_PrepareStart`: its exact 239/110 private authorization listed
  legacy and W3 modes but omitted the new W5 ladder mode.
- Candidate 7 (`algorithm=0x001A`, `run=0x25090611`) adds only W5 to that compile-
  gated private whitelist; all latch, stage, comparator, fault, PWM-off, and OST
  gates remain. Public envelopes, thresholds, cycle caps, and protection are unchanged.
- New authorization suite and all existing regression suites PASS; both builds exit 0.
  On-target NE walk passes 5/5 rungs with zero abort, zero TZCLR/enable writes,
  cookie `0x57353573`, final PWM 0, and OST latched.
- Frozen REAL OUT: `A323D75006E00226EBBC02620110D7C5F40E40043F9C3FFBE705CE66CFD9625C`.
  Frozen NE OUT: `3D9F61289285FFCCD849E1AA7B5D0993D61A950DAE7B658DA796DF22AE323837`.
- Evidence: `evidence/sol_master_execution/w5_12v_transition/w5_real_attempt6_auth_omission_candidate7_ne_pass.txt`.
- Next: fresh CR15/Vin24V/0.7A confirmation, then one real fire of candidate 7.
- `W5_REAL_POWER_PASS_CLAIMED=FALSE`.
